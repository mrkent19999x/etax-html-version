...
import { getUserSession, getProfile, logoutUser, isAuthenticated } from './auth.js';
import { navigateTo, setViewportHeight } from './utils.js';

// Initialize
document.addEventListener('DOMContentLoaded', () => {
  // Set viewport height (fix iOS issues)
  setViewportHeight();
